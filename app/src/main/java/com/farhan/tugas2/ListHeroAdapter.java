...
//            Intent intent = new Intent(holder.itemView.getContext(), HeroActivity.class);
//            intent.putExtra("key", listHero.get(holder.getAdapterPosition()).getName());
